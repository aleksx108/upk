    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <form method="POST" action="{{ route('occupations.update', $occupation) }}" class="space-y-6" novalidate>
                    @csrf
                    @method('PUT')

                    @include('occupations.partials.form', ['occupation' => $occupation])
